...
![Node's mascot, a turtle with an aviator hat and goggles, riding a rocket like a skateboard](./node.js_mascot.png "Rad dude, probably too rad to be the face of such a monolithic pillar of the web")
...
![Bun's Logo, a steamed bun with round black eyes and an open, smiling mouth](./bun-logo.svg "They do a lot of branding based around Bun as in Dumpling, and it works in the context of a JavaScript Bundler, but they occasionally reference Bun as an abbreviation for Bunny. That's the kind of flexibility you need to stand a chance against Node.")
...
![Image](./heaviest-in-the-universe-node-modules.png "This one folder is probably the reason .gitignore even exists")
...
![An image of a long-necked dinosaur with the word "DENO" next to it](./dark-transparent.svg "It's even poking its little head around the code examples on their website. I like to imagine it's working in the server room, helping with the tall stacks")
